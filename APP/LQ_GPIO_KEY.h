...
//定义的管脚要对应实际按键
#define KEY0p      GPIOD,GPIO_Pin_4   //母板上按键0
#define KEY1p      GPIOD,GPIO_Pin_2   //母板上按键1
#define KEY2p      GPIOD,GPIO_Pin_3   //母板上按键2
#define DSW0p      GPIOD,GPIO_Pin_0   //母板上拨码开关0,默认拨到下方是高电平，上方为低电平
#define DSW1p      GPIOD,GPIO_Pin_1   //母板上拨码开关1
