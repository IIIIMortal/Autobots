...
//龙邱OLED 模块管脚顺序
#define OLED_CK       GPIOE,GPIO_Pin_5     //OLED CK管脚
#define OLED_DI	      GPIOE,GPIO_Pin_2     //OLED DI管脚
#define OLED_RST      GPIOE,GPIO_Pin_6     //OLED RST管脚
#define OLED_DC	      GPIOE,GPIO_Pin_4     //OLED DC管脚
#define OLED_CS	      GPIOE,GPIO_Pin_3     //OLED CS管脚 默认拉低，可以不用

//龙邱TFT SPI口模块管脚顺序
#define TFTSPI_CS     GPIOE,GPIO_Pin_3     // CS管脚 默认拉低，可以不用
#define TFTSPI_SCK    GPIOE,GPIO_Pin_5     // SPI SCK管脚
#define TFTSPI_SDI    GPIOE,GPIO_Pin_2     // SPI MOSI管脚
#define TFTSPI_DC     GPIOE,GPIO_Pin_4     // D/C管脚
#define TFTSPI_RST    GPIOE,GPIO_Pin_6     // RESET管脚
...
void TFTSPI_Init(unsigned short type)
{
  ...
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2|GPIO_Pin_3|GPIO_Pin_4|GPIO_Pin_5|GPIO_Pin_0;
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
  GPIO_Init(GPIOE, &GPIO_InitStructure);  
  */
  PIN_InitConfig(PE2, GPO, 0,GPIO_Mode_Out_PP);
  PIN_InitConfig(PE3, GPO, 0,GPIO_Mode_Out_PP);
  PIN_InitConfig(PE4, GPO, 0,GPIO_Mode_Out_PP);
  PIN_InitConfig(PE5, GPO, 0,GPIO_Mode_Out_PP);
  PIN_InitConfig(PE6, GPO, 0,GPIO_Mode_Out_PP);
...
const unsigned short Font_code8[][6] = {
