...
//龙邱TFT SPI口模块管脚顺序
#define TFTSPI_CS     GPIOE,GPIO_Pin_5     // CS管脚 默认拉低，可以不用
#define TFTSPI_SCK    GPIOE,GPIO_Pin_2     // SPI SCK管脚
#define TFTSPI_SDI    GPIOE,GPIO_Pin_6     // SPI MOSI管脚
#define TFTSPI_DC     GPIOE,GPIO_Pin_4     // D/C管脚
#define TFTSPI_RST    GPIOE,GPIO_Pin_3     // RESET管脚
